<?php
/**
 * proxy for the Brightcove Cross-Device Resume (XDR) RESTful API
...
// security checks
// this check is for the proxy on the Brightcove server
// to prevent people from unwisely using it in a production
// app. You should either modify it to reflect your
// server address, or remove lines 26-28
...
    exit('{"error_code":"Only requests from https:solutions.brightcove.com are accepted by this proxy"}');
}
...
// if you wish, you can include default
// client id and secret values in case none
// are passed in requests to the proxy
$client_id     = '';
$client_secret = '';
